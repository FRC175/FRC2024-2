...
//start 60,
    //drive 25
public class CloseDoubleSideNote extends SequentialCommandGroup{
    public CloseDoubleSideNote(Drive drive, Shooter shooter, Intake intake, Arm arm, Limelight limelight) {
        ...
        addCommands(
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    // new SwerveToDist(drive, 0.8, 0, 0, 1.2),

                    new DriveWhileIntaking(intake, drive, arm, 0.5, 1.75, Utils.convToSideAngle(15), Utils.convToSideAngle(15), 2),
                    // new SwerveToDist(drive, 0.6, Utils.convToSideAngle(200), Utils.convToSideAngle(25), 6.3),
