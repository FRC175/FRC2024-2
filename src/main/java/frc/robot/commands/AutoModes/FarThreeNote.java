...
//start 60,
    //drive 25
public class FarThreeNote extends SequentialCommandGroup{
    public FarThreeNote(Drive drive, Shooter shooter, Intake intake, Arm arm) {
        ...
        addCommands(
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    new SwerveToDist(drive, 0.8, Utils.convToSideAngle(45), Utils.convToSideAngle(45), 3.85),
                    new DriveWhileIntaking(intake, drive, arm, 0.5, 4.9, 0, Utils.convToSideAngle(10), 5),
                    new SwerveToDist(drive, 0.6, Utils.convToSideAngle(200), Utils.convToSideAngle(20), 6.5),
