...
public class MultiNoteSkipAmp extends SequentialCommandGroup {

   public MultiNoteSkipAmp(Drive drive, Shooter shooter, Intake intake, Arm arm, Limelight limelight) {
    ...
    addCommands(
        new ParallelCommandGroup(
            ...
            new SequentialCommandGroup(
                ...
                new SwerveToDist(drive, 0.1, Utils.convToSideAngle(300), Utils.convToSideAngle(330), 0.7),
